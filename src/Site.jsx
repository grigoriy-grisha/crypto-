...
const Site = () => {
    ...
    const connectToAccount = (id) => {
        Accept(id, handleAdressChanged(id))
    }


    return (
        <>  <ConnectWalletModal userCameFrom={userCameFrom} accountType={accountType} mode={mode}
                                amountOfBoxes={amountOfBoxes} connectToAccount={connectToAccount}
                    ...
                    <div className={styles.NFT_Flex}>
                        ...
                        <div className={styles.NFT_Flex__LimitedScroll} style={{zIndex: 2, paddingBottom: 40,}}>
                            ...
                            <div className={styles.NFT_Flex__LimitedScroll_Scroll}>
                                <input value={amountOfBoxes} style={{margin: 0, padding: 0}} onChange={sliderOnChange}
                                       type="range"
                                       min={1} max={10}
                                       id='range'/>
                            </div>
                            ...
                            <div className={styles.NFT_Flex__LimitedScroll_ConnectWallet} style={{zIndex: 4}}
                                 onClick={() => {
                                     if (!account) {
                                         openConnectWalletModal()
                                         setMode("CONNECT")
